...
const mainCases=[['lawful',{},false],['mutate-path-after-check',{},false],['stall-checker',{'checker-timeout-ms':'500'},false],['malformed-checker',{},false],['blob-error',{},false],['create-not-ok',{},false],['finalize-not-ok',{},false],['bad-artifact-id',{},false],['missing-runtime',{},true],['bad-integer',{'run-id':'17junk'},false],['bad-budget',{'max-archive-bytes':'67108865'},false]];
