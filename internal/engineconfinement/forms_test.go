...
// TestEngineRuleKnowsEveryPublishedFormOfTheStack — импорт каждой формы ВНЕ
// поддерева — ровно одна находка с координатой; тот же файл ВНУТРИ поддерева —
// молчание (отличие — одно место).
