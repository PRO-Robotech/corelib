...
//
// У слепой зоны держателя НЕТ ни на одном пути запроса. Перепись этой пробы о
// ней не говорит ничего: с записью слепой зоны в дереве находок и неразобранных
// у неё так же ноль — это и утверждает TestNamedBlindZoneFormsStaySilent. -race
// проба одновременных обменов
