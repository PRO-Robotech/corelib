...
// обработчики, стратегию подписи. Всё это держит только -race проба
// TestConcurrentExchangesOnAFreshCeremonyShareNoEngineState — на пути обмена и
// лишь тогда, когда запись случается в её прогоне; на остальных путях запроса
// держателя нет.
